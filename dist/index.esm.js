...
var isQaApi = window.location.host.includes('9.16');
var isProdApi = window.location.host.includes('com') || window.location.host.includes('cn');
var isBetaApi = window.location.host.includes('beta');
...
export { BASE_URL, isBetaApi, isProdApi, isQaApi };
